...
from data_processing.detect_spills import detection_pipeline
...
def detect_spills(request):
    ...
    markers = detection_pipeline(left_upper_corner, right_upper_corner, left_bottom_corner, right_bottom_corner,
